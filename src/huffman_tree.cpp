...
Node *huffman_tree::constructTree(const std::string &input_file_content) {
...
std::vector<int>
huffman_tree::getCharFrequencies(const std::string &input_file_content) {
...
void huffman_tree::dfs(const Node *node, std::vector<std::string> &codes,
...
std::vector<std::string> huffman_tree::parse(const std::string &input) {
